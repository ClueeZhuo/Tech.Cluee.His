...
namespace Tech.Cluee.HisData.Model
{
    ...
    public partial class ZDSF : Entity<ZDSF>
    {
        ...
        static ZDSF()
        {
            ...
            // 单对象缓存
            ISingleEntityCache<object, ZDSF> sc = Meta.SingleCache;
            sc.FindSlaveKeyMethod = k => Find(_.BM == k);
        ...
        public static ZDSF FindByID(int id)
        {
            if (id <= 0)
            {
                return null;
        ...
        public static ZDSF FindByBM(string bm)
        {
            ...
            if (Meta.Session.Count < 1000)
            {
                return Meta.Cache.Find(e => e.BM == bm);
            }
        ...
        public static IList<ZDSF> Search(string bm, DateTime start, DateTime end, string key, PageParameter page)
        {
            ...
            {
                exp &= _.DH.Contains(key) | _.MC.Contains(key) | _.DW.Contains(key) | _.CreateUser.Contains(key) | _.CreateIP.Contains(key) | _.UpdateUser.Contains(key) | _.UpdateIP.Contains(key);
            }
        ...
        //static readonly FieldCache<ZDSF> _CategoryCache = new FieldCache<ZDSF>(nameof(Category))
        //{
