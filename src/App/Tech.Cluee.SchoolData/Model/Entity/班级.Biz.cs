...
namespace Tech.Cluee.HisWeb.Areas.School.Model
{
    ...
    public partial class Class : Entity<Class>
    {
        ...
        // Select Count(ID) as ID,Category From Class Where CreateTime>'2020-01-24 00:00:00' Group By Category Order By ID Desc limit 20
        //static readonly FieldCache<Class> _CategoryCache = new FieldCache<Class>(nameof(Category))
        //{
