...
namespace Tech.Cluee.HisWeb.Areas.School.Model
{
    ...
    public partial class Student : Entity<Student>
    {
        ...
        public static IList<Student> FindAllByClassID(int classId)
        {
            // 实体缓存
            if (Meta.Session.Count < 1000)
            {
                return Meta.Cache.FindAll(e => e.ClassID == classId);
            }
        ...
        /// <returns>实体列表</returns>
        public static IList<Student> Search(int classId, DateTime start, DateTime end, string key, PageParameter page)
        {
            ...
            {
                exp &= _.Name.Contains(key) | _.Mobile.Contains(key) | _.Address.Contains(key) | _.CreateIP.Contains(key) | _.UpdateIP.Contains(key) | _.Remark.Contains(key);
            }
